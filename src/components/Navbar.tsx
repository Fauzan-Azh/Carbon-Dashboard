        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link
              ...
              className={`flex items-center space-x-2 transition-colors duration-200 px-4 py-2 rounded-lg ${
                pathname === '/' 
                  ...
                  : 'text-gray-700 hover:text-blue-600 border-2 border-transparent'
              }`}
              style={{
            ...
            <Link
              ...
              onMouseEnter={(e) => {
                if (pathname !== '/electricity-bills' && !pathname.startsWith('/electricity-bills/')) {
                  e.currentTarget.style.color = '#2563eb';
                }
              }}
              onMouseLeave={(e) => {
            ...
            <Link
              ...
              onMouseEnter={(e) => {
                if (pathname !== '/student-housing' && !pathname.startsWith('/student-housing/')) {
                  e.currentTarget.style.color = '#2563eb';
                }
              }}
              onMouseLeave={(e) => {
